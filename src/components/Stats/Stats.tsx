...
function Stats() {
  return (
    <div className="mx-auto pt-12 px-4 md:pr-8 md:pl-0 lg:pr-10 flex flex-col items-center">
      ...
      {/* stats section  */}
      <section className="">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:pt-20">
          <dl className="grid max-w-screen-md gap-32 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
