...
//   return (
//     <div id="Events" className="w-full grid grid-cols-2 pt-20 pb-40">
//       <div className="col-span-1 flex justify-center items-center">
//         <img src={LaptopMockup} alt="" className="w-[69%] mx-auto py-20" />
//       </div>
...
const Eventdetails = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full mt-16 bg-dark font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-sm md:text-4xl mb-4 font-bold text-black dark:text-white max-w-4xl">
          Global Gam Jam
        </h2>
        <p className="text-gray-200 dark:text-neutral-300 text-xs md:text-sm max-w-sm">
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-lg mb-4 text-left font-bold text-neutral-300 dark:text-neutral-300">
                {item.title}
              </h3>
              ...
              {/* Content Section */}
              <div className="text-sm md:text-lg text-neutral-500 font-bold">{item.content}</div>
            </div>
          </div>
        ))}
